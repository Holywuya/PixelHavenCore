...
object AdminGuiService {
    ...
    private val pendingChatInputs = PlayerSessionMap<PendingChatInput>({ throw IllegalStateException() })
    private val deleteTargets = PlayerSessionMap<DeleteTarget>({ throw IllegalStateException() })
    ...
    fun hasPendingInput(playerId: UUID): Boolean = pendingChatInputs[playerId] != null
